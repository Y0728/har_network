...
def parse_args():
    ...
    parser.add_argument('--model', default='PointNet_Vit', help='model name [default: pointnet_cls]')
    ...
    parser.add_argument('--activity_list', default=['walk','run','sit','jump','fall'], help='activity types') #['fall', 'run']
...
def main(args):
    ...
    shutil.copy('./train_classification_pn_vit.py', str(exp_dir))
