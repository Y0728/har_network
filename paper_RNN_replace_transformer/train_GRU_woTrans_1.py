...
def parse_args():
    ...
    parser.add_argument('--model', default='PointNet_rnn_woTransformer_0037', help='model name [default: pointnet_cls]')
    ...
    parser.add_argument('--activity_list', default=['stand'], help='activity types') #['fall', 'run']','stand','jump','sit','fall','run','walk','bend'#'walk','fall','stand','sit'
...
def main(args):
    ...
    ## 0037
    classifier = model.PointNet_Vit( num_layers = 2, input_size=128,hidden_size = 256, num_classes = num_class, normal_channel=args.use_normals, model=args.rnn_type)
