...
class PointNet_Vit(nn.Module):
    ...
    def __init__(self, num_layers, hidden_size,seq_len, k = 5, normal_channel = True, feat_trans = False,model = 'rnn',img_size=224, patch_size=16, in_chans=3, num_classes=8, embed_dim=512, depth=12,
