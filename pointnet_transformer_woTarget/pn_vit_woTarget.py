...
class PointNet_Vit(nn.Module):
    ...
    def __init__(self, num_layers, hidden_size,seq_len, k = 5, normal_channel = True, model = 'rnn',img_size=224, patch_size=16, in_chans=3, num_classes=8, embed_dim=256, depth=12,
                 num_heads=8, mlp_ratio=4., qkv_bias=True, representation_size=None, distilled=False,
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0., embed_layer=PatchEmbed, norm_layer=None,
                 act_layer=None, weight_init=''):   #因为不用target信息，所以吧embeded_size改成了256
        """
        Args:
