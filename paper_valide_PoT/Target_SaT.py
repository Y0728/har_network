...
from pointnet_utils_valide_SaT import PointNetEncoder, feature_transform_reguliarzer
...
class PointNet_Vit(nn.Module):
    ...
    def __init__(self,  seq_len, num_classes, normal_channel = True, embed_dim=128, depth=2,
    ...
    def forward_pn_features(self, target_data):
        # sample_fea = np.array([])
    ...
    def forward(self, target_data):
        ...
        x = self.forward_pn_features(target_data)
